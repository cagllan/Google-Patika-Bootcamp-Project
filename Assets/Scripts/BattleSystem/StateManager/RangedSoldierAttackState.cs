...
public class RangedSoldierAttackState : SoldierAttackBaseState
{
    ...
    {
        Projectile bullet = GameObject.Instantiate(_bulletPrefab, _arrowRefTransform.position + new Vector3(0, 2, 0) , Quaternion.LookRotation(_soldierTargetProvider.GetTargetSoldier().transform.position - _mySoldier.transform.position));
    }
